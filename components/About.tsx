            ...
            <GlassCard>
                ...
                <div className="flex flex-col md:flex-row items-center gap-12" style={{ transform: "translateZ(25px)"}}>
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed">
                        As a final-year Computer Engineering student at SIIT, Thammasat University , and a Health Science student at the University of People, I have a strong foundation in both software and hardware. My expertise in Data Visulization and purposing methods and on the way of process in publishing the conference paper of adaptive sampling rate and extraction methods of wave height with raw water level data, and in software development is highlighted by my research in medical image processing, where I've developed algorithms to enhance and classify digital images , and a project focused on localizing hemorrhages in OCT scans.
                        <br/><br/>
                        On the hardware side, I have hands-on experience in developing the web-app, PLC and Hydraulic machine testing on hardware components, and designign the whole process as the customer need as Fixed-Term Service Application Engieer in Bosch Rexroth, and developing an IoT-based automatic agricultural watering system using Arduino as my freelance project. My practical skills were further refined during an internship at NECTEC, where I built a hardware model for wave simulation to measure coastal erosion. I am proficient in languages like Python, JAVA, and C#.Net and am eager to apply my balanced skill set to create innovative, impactful solutions that bridge the gap between the physical and digital worlds.
                    </p>
                </div>
            </GlassCard>
        </motion.section>
